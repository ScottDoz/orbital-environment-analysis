# -*- coding: utf-8 -*-
"""
Created on Mon Sep 13 15:45:16 2021
...
This module contains functions implementing vectorized versions of optimizers.
...
def chandrupatla(f,x0,x1,verbose=False, 
    ...
    Source: jason-s, 31 March 2017 in scipy github issues https://github.com/scipy/scipy/issues/7242
    
    Method is described in author's blog post:
