...
{
    "distutils": {
        "name": "vectorized_kepler",
        "sources": [
            "vectorized_kepler.pyx"
        ]
    },
    "module_name": "vectorized_kepler"
}
END: Cython Metadata */
...
#define __PYX_HAVE__vectorized_kepler
#define __PYX_HAVE_API__vectorized_kepler
/* Early includes */
#include <math.h>
#include "pythread.h"
#include <string.h>
...
struct __pyx_t_17vectorized_kepler_test_params;
typedef struct __pyx_t_17vectorized_kepler_test_params __pyx_t_17vectorized_kepler_test_params;

/* "vectorized_kepler.pyx":22
 * 
...
/* Module declarations from 'vectorized_kepler' */
...
static double __pyx_f_17vectorized_kepler_func_E(double, void *); /*proto*/
static double __pyx_f_17vectorized_kepler_func_H(double, void *); /*proto*/
static int __pyx_f_17vectorized_kepler_Kepler_cython(__Pyx_memviewslice, __Pyx_memviewslice, double, double, int, __Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "vectorized_kepler"
extern int __pyx_module_is_main_vectorized_kepler;
int __pyx_module_is_main_vectorized_kepler = 0;

/* Implementation of 'vectorized_kepler' */
...
static const char __pyx_k_Kepler_loop[] = "Kepler_loop";
...
static const char __pyx_k_vectorized_kepler[] = "vectorized_kepler";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_strided_and_direct[] = "<strided and direct>";
static const char __pyx_k_strided_and_indirect[] = "<strided and indirect>";
static const char __pyx_k_contiguous_and_direct[] = "<contiguous and direct>";
static const char __pyx_k_vectorized_kepler_pyx[] = "vectorized_kepler.pyx";
...
static PyObject *__pyx_n_s_Kepler_loop;
...
static PyObject *__pyx_n_s_vectorized_kepler;
static PyObject *__pyx_kp_s_vectorized_kepler_pyx;
static PyObject *__pyx_n_s_xtol;
static PyObject *__pyx_pf_17vectorized_kepler_Kepler_loop(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_e, PyObject *__pyx_v_M, PyObject *__pyx_v_xtol, PyObject *__pyx_v_rtol, PyObject *__pyx_v_mitr); /* proto */
...
static double __pyx_f_17vectorized_kepler_func_E(double __pyx_v_x, void *__pyx_v_args) {
  __pyx_t_17vectorized_kepler_test_params *__pyx_v_myargs;
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("func_E", 0);

  /* "vectorized_kepler.pyx":29
 * # f(x) = x - e*sin(x) - M = 0
 * cdef double func_E(double x, void *args):
 *     cdef test_params *myargs = <test_params *> args             # <<<<<<<<<<<<<<
 *     return x -myargs.e*math.sin(x) - myargs.M
 * 
 */
  __pyx_v_myargs = ((__pyx_t_17vectorized_kepler_test_params *)__pyx_v_args);

  /* "vectorized_kepler.pyx":30
 * cdef double func_E(double x, void *args):
 *     cdef test_params *myargs = <test_params *> args
 *     return x -myargs.e*math.sin(x) - myargs.M             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_r = ((__pyx_v_x - (__pyx_v_myargs->e * sin(__pyx_v_x))) - __pyx_v_myargs->M);
  goto __pyx_L0;
...
static double __pyx_f_17vectorized_kepler_func_H(double __pyx_v_x, void *__pyx_v_args) {
  __pyx_t_17vectorized_kepler_test_params *__pyx_v_myargs;
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("func_H", 0);

  /* "vectorized_kepler.pyx":35
 * # f(x) = e*sinh(x) - x - M = 0
 * cdef double func_H(double x, void *args):
 *     cdef test_params *myargs = <test_params *> args             # <<<<<<<<<<<<<<
 *     return myargs.e*math.sinh(x) - x - myargs.M
 ...
 * 
 */
  __pyx_r = (((__pyx_v_myargs->e * sinh(__pyx_v_x)) - __pyx_v_x) - __pyx_v_myargs->M);
  goto __pyx_L0;
...
static int __pyx_f_17vectorized_kepler_Kepler_cython(__Pyx_memviewslice __pyx_v_e, __Pyx_memviewslice __pyx_v_M, double __pyx_v_xtol, double __pyx_v_rtol, int __pyx_v_mitr, __Pyx_memviewslice __pyx_v_result) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("Kepler_cython", 0);

  /* "vectorized_kepler.pyx":41
 * # Cython wrapper function
 * cdef int Kepler_cython(double[:] e, double[:] M, double xtol, double rtol, int mitr, double[:] result):
 *     cdef Py_ssize_t i = 0             # <<<<<<<<<<<<<<
 *     cdef test_params myargs
 ...
 */
    ...
    __pyx_t_4 = -1;
    if (__pyx_t_3 < 0) {
      __pyx_t_3 += __pyx_v_e.shape[0];
      if (unlikely(__pyx_t_3 < 0)) __pyx_t_4 = 0;
    } else if (unlikely(__pyx_t_3 >= __pyx_v_e.shape[0])) __pyx_t_4 = 0;
    if (unlikely(__pyx_t_4 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_4);
      __PYX_ERR(0, 46, __pyx_L1_error)
    }
    __pyx_v_myargs.e = (*((double *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_3 * __pyx_v_e.strides[0]) )));

    /* "vectorized_kepler.pyx":47
 *     while i < len(M):
 *         myargs.e = e[i]
 *         myargs.M = M[i]             # <<<<<<<<<<<<<<
 *         if e[i]<1.:
 ...
 */
    ...
    if (__pyx_t_3 < 0) {
      ...
      if (unlikely(__pyx_t_3 < 0)) __pyx_t_4 = 0;
    } else if (unlikely(__pyx_t_3 >= __pyx_v_M.shape[0])) __pyx_t_4 = 0;
    if (unlikely(__pyx_t_4 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_4);
      __PYX_ERR(0, 47, __pyx_L1_error)
    }
    __pyx_v_myargs.M = (*((double *) ( /* dim=0 */ (__pyx_v_M.data + __pyx_t_3 * __pyx_v_M.strides[0]) )));

    /* "vectorized_kepler.pyx":48
 *         myargs.e = e[i]
 *         myargs.M = M[i]
 *         if e[i]<1.:             # <<<<<<<<<<<<<<
 *             # Elliptical orbit
 ...
 */
    ...
    __pyx_t_2 = (((*((double *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_3 * __pyx_v_e.strides[0]) ))) < 1.) != 0);
    if (__pyx_t_2) {

      /* "vectorized_kepler.pyx":50
 *         if e[i]<1.:
 *             # Elliptical orbit
 *             result[i] = brentq(func_E, 0., 2*np.pi, <test_params *> &myargs, xtol, rtol, mitr, NULL)             # <<<<<<<<<<<<<<
 *         elif e[i]>=1:
 ...
 */
      ...
      __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_pi); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 50, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = PyNumber_Multiply(__pyx_int_2, __pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 50, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      ...
      __pyx_t_4 = -1;
      if (__pyx_t_3 < 0) {
        __pyx_t_3 += __pyx_v_result.shape[0];
        if (unlikely(__pyx_t_3 < 0)) __pyx_t_4 = 0;
      } else if (unlikely(__pyx_t_3 >= __pyx_v_result.shape[0])) __pyx_t_4 = 0;
      if (unlikely(__pyx_t_4 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_4);
        __PYX_ERR(0, 50, __pyx_L1_error)
      }
      *((double *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_3 * __pyx_v_result.strides[0]) )) = __pyx_f_5scipy_8optimize_15cython_optimize_6_zeros_brentq(__pyx_f_17vectorized_kepler_func_E, 0., __pyx_t_7, ((__pyx_t_17vectorized_kepler_test_params *)(&__pyx_v_myargs)), __pyx_v_xtol, __pyx_v_rtol, __pyx_v_mitr, NULL);
 ...
 */
    ...
    __pyx_t_2 = (((*((double *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_3 * __pyx_v_e.strides[0]) ))) >= 1.0) != 0);
    if (__pyx_t_2) {

      /* "vectorized_kepler.pyx":53
 *         elif e[i]>=1:
 *             # Hyperbolic orbit
 *             result[i] = brentq(func_H, 0., 2*np.pi, <test_params *> &myargs, xtol, rtol, mitr, NULL)             # <<<<<<<<<<<<<<
 *         i += 1
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_pi); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 53, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = PyNumber_Multiply(__pyx_int_2, __pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 53, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_7 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_7 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 53, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_3 = __pyx_v_i;
      __pyx_t_4 = -1;
      if (__pyx_t_3 < 0) {
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_3 * __pyx_v_result.strides[0]) )) = __pyx_f_5scipy_8optimize_15cython_optimize_6_zeros_brentq(__pyx_f_17vectorized_kepler_func_H, 0., __pyx_t_7, ((__pyx_t_17vectorized_kepler_test_params *)(&__pyx_v_myargs)), __pyx_v_xtol, __pyx_v_rtol, __pyx_v_mitr, NULL);
 ...
 */
  ...
  __Pyx_WriteUnraisable("vectorized_kepler.Kepler_cython", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_17vectorized_kepler_1Kepler_loop(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_17vectorized_kepler_Kepler_loop[] = "\n    Python wrapper to Kepler_cython Cython function.\n\n    Vectorized implementation of Kepler's equation using scipy brent solver\n    within a Cython loop.\n    ";
static PyMethodDef __pyx_mdef_17vectorized_kepler_1Kepler_loop = {"Kepler_loop", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_17vectorized_kepler_1Kepler_loop, METH_VARARGS|METH_KEYWORDS, __pyx_doc_17vectorized_kepler_Kepler_loop};
static PyObject *__pyx_pw_17vectorized_kepler_1Kepler_loop(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("Kepler_loop (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_e,&__pyx_n_s_M,&__pyx_n_s_xtol,&__pyx_n_s_rtol,&__pyx_n_s_mitr,0};
    PyObject* values[5] = {0,0,0,0,0};
    values[2] = ((PyObject *)__pyx_float_1eneg_5);
    values[3] = ((PyObject *)__pyx_float_1eneg_5);
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_M)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("Kepler_loop", 0, 2, 5, 1); __PYX_ERR(0, 58, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "Kepler_loop") < 0)) __PYX_ERR(0, 58, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_e = values[0];
    __pyx_v_M = values[1];
    __pyx_v_xtol = values[2];
    __pyx_v_rtol = values[3];
    __pyx_v_mitr = values[4];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("Kepler_loop", 0, 2, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 58, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("vectorized_kepler.Kepler_loop", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_17vectorized_kepler_Kepler_loop(__pyx_self, __pyx_v_e, __pyx_v_M, __pyx_v_xtol, __pyx_v_rtol, __pyx_v_mitr);
...
static PyObject *__pyx_pf_17vectorized_kepler_Kepler_loop(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_e, PyObject *__pyx_v_M, PyObject *__pyx_v_xtol, PyObject *__pyx_v_rtol, PyObject *__pyx_v_mitr) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("Kepler_loop", 0);

  /* "vectorized_kepler.pyx":65
 *     within a Cython loop.
 *     '''
 ...
 */
  ...
  /* "vectorized_kepler.pyx":66
 *     '''
 *     cdef double[:] result = np.empty_like(M)
 *     if not Kepler_cython(e, M, xtol, rtol, mitr, result):             # <<<<<<<<<<<<<<
 *         return result
 */
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_e, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 66, __pyx_L1_error)
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_M, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 66, __pyx_L1_error)
  __pyx_t_6 = __pyx_PyFloat_AsDouble(__pyx_v_xtol); if (unlikely((__pyx_t_6 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 66, __pyx_L1_error)
  __pyx_t_7 = __pyx_PyFloat_AsDouble(__pyx_v_rtol); if (unlikely((__pyx_t_7 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 66, __pyx_L1_error)
  __pyx_t_8 = __Pyx_PyInt_As_int(__pyx_v_mitr); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 66, __pyx_L1_error)
  __pyx_t_9 = ((!(__pyx_f_17vectorized_kepler_Kepler_cython(__pyx_t_4, __pyx_t_5, __pyx_t_6, __pyx_t_7, __pyx_t_8, __pyx_v_result) != 0)) != 0);
  ...
  if (__pyx_t_9) {
    ...
    /* "vectorized_kepler.pyx":67
 *     cdef double[:] result = np.empty_like(M)
 *     if not Kepler_cython(e, M, xtol, rtol, mitr, result):
 *         return result             # <<<<<<<<<<<<<<
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_result, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 67, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_r = __pyx_t_1;
    __pyx_t_1 = 0;
    goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "vectorized_kepler.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "vectorized_kepler.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "vectorized_kepler.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "vectorized_kepler._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_vectorized_kepler(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_vectorized_kepler},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "vectorized_kepler",
    __pyx_k_Created_on_Thu_Sep_23_19_46_09, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_Kepler_loop, __pyx_k_Kepler_loop, sizeof(__pyx_k_Kepler_loop), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_vectorized_kepler, __pyx_k_vectorized_kepler, sizeof(__pyx_k_vectorized_kepler), 0, 0, 1, 1},
  {&__pyx_kp_s_vectorized_kepler_pyx, __pyx_k_vectorized_kepler_pyx, sizeof(__pyx_k_vectorized_kepler_pyx), 0, 0, 1, 0},
 ...
 *     Python wrapper to Kepler_cython Cython function.
 */
  __pyx_tuple__19 = PyTuple_Pack(6, __pyx_n_s_e, __pyx_n_s_M, __pyx_n_s_xtol, __pyx_n_s_rtol, __pyx_n_s_mitr, __pyx_n_s_result); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(5, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_vectorized_kepler_pyx, __pyx_n_s_Kepler_loop, 58, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 58, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initvectorized_kepler(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initvectorized_kepler(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_vectorized_kepler(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_vectorized_kepler(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_vectorized_kepler(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'vectorized_kepler' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_vectorized_kepler(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("vectorized_kepler", __pyx_methods, __pyx_k_Created_on_Thu_Sep_23_19_46_09, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_vectorized_kepler) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "vectorized_kepler")) {
      if (unlikely(PyDict_SetItemString(modules, "vectorized_kepler", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     Python wrapper to Kepler_cython Cython function.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_17vectorized_kepler_1Kepler_loop, NULL, __pyx_n_s_vectorized_kepler); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_Kepler_loop, __pyx_t_1) < 0) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "vectorized_kepler.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * """
 * Created on Thu Sep 23 19:46:09 2021
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init vectorized_kepler", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init vectorized_kepler");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
